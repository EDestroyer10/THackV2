...
public class AntiDoubleTapFeature extends Feature implements UpdateListener {
	...
	private final BooleanSetting checkPlayersAround = new BooleanSetting("checkPlayersAround", "check players around you", false, this);
	private final DecimalSetting distance = new DecimalSetting("distance", "distance when auto double hand activates", 6, this);
	private final BooleanSetting predictCrystals = new BooleanSetting("predictCrystals", "predict if players around you are gonna place crystals", false, this);
	private final BooleanSetting checkEnemiesAim = new BooleanSetting("checkEnemiesAim", "check where player's are pointing at", false, this);
	private final BooleanSetting checkHoldingItems = new BooleanSetting("checkHoldingItems", "checks if players are holding crystals", false, this);
	...
	private final BooleanSetting stopOnUsingItem = new BooleanSetting("stopOnUsingItem", "makes it so you wont swap to your totem when youre eating", false, this);
